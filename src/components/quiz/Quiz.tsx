    ...
    <div className={styles.quiz}>
      ...
      <>
        ...
        <div className={styles.card}>
          ...
          {selectedQuestion !== questions[currentQuestion] && selectedQuestion.isAnswered && <button className={styles.buttonNext} onClick={() => setSelectedQuestion(questions[currentQuestion])}>Next Question</button>}
        </div>
      </>}
      {currentQuestion >= 10 && 
      <div className={styles.card}>
